  ...
  window.sankey = sankey;
	...
	const data = {"nodes":[{"name":"A"},{"name":"F"},{"name":"C"},{"name":"B"},{"name":"E"},{"name":"D"}], "links":[{"source":0,"target":1,"value":1},{"source":0,"target":2,"value":1},{"source":3,"target":4,"value":1},{"source":2,"target":5,"value":1},{"source":5,"target":4,"value":1}]}
        ...
        let linkColor="source-target" // source, target, source-target
        let align="justify"     // "left", "right", "justify", "center"
        ...
        function drawchart() {
            ...
            document.getElementById("sankey-plot").appendChild(chart)
      		}
